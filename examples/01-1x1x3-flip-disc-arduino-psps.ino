...
void loop() 
{
  ...
  FlipDisc.Flip3(1,1,1,1);    /* Set all discs */
  delay(1000);

  FlipDisc.Flip3(1,0);        /* Reset first disc */
  delay(1000);

  FlipDisc.Flip3(1,1,0);      /* Set first disc and reset second */
  delay(1000);

  FlipDisc.Flip3(1,0,0,0);    /* Reset all discs */
  delay(3000);
